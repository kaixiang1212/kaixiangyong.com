...
{#if mounted}
  <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-3/4 flex items-center justify-center">
    <div class="max-h-80" in:fade|global>
    ...
    <div class="flex flex-col md:pl-6 pl-2" in:fade|global>
      ...
      <h2 in:fade|global class="mb-3 font-normal text-gray-500 dark:text-gray-400 text-sm md:text-base">
