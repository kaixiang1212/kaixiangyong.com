export const experiences = [
    {
        ...
        summary: 'Design and manage web application for Test Vector Processing and Validation, delivering innovative test solutions and automation tools to enhance test capability and work efficiency in product development engineering.',
        points: []
    },
    {
